 ...
 * @author Pedro Silva
 */
public class Ecra_Dono_Dados extends javax.swing.JPanel {
    private Frame_Inicial frame ;
    private Dono dono = null, hold = null;
    private int cc, nif, contacto ;
    /**
     * Creates new form Ecra_Cliente_Dados
     */
    public Ecra_Dono_Dados(Frame_Inicial frame, Dono dono) {
        initComponents();
        this.frame = frame ;
        this.dono = dono ;
        ...
        this.jTextFieldUser.setText(dono.getUser());
        this.jTextFieldPasswd.setText(dono.getPasswd());
        this.jTextFieldNome.setText(dono.getNome());
        this.jTextFieldCC.setText(String.valueOf(dono.getNumcc()));
        this.jTextFieldNif.setText(String.valueOf(dono.getNif()));
        this.jTextFieldContacto.setText(String.valueOf(dono.getContacto()));
        this.jTextFieldLocalidade.setText(dono.getLocalidade());
        this.jTextFieldMorada.setText(dono.getMorada());
    }
    ...
    private void jButtonEfetuarAlteraçoesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEfetuarAlteraçoesActionPerformed
        ...
        try {
            Repositorio.getInstance().alterarInfoDono(hold, dono);
